...
df = pd.read_excel(excel_file, sheet_name="Consolidated Statements of Oper")
...
for row in df.itertuples(index=False):
    ...
    cursor.execute("INSERT INTO income_statement (Account, `12/31/2022`, `12/31/2021`, `12/31/2020`) VALUES (?, ?, ?, ?)",
...
print("Data imported successfully into the income_statement table.")
